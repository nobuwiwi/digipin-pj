...
import { ArrowLeft, Trophy, Target, MapPin, Calendar, Users, QrCode, Edit3, Minus } from "lucide-react";
...
export function CompetitionManageScreen({
  deviceId,
  competitionId,
  onBack,
  onEdit,
    ...
    <div className="min-h-screen bg-gradient-to-b from-forest-50 to-white">
      ...
      <div className="sticky top-0 z-30 bg-white/90 backdrop-blur-md border-b border-forest-100">
        <div className="max-w-lg mx-auto flex items-center gap-3 px-4 py-3">
          ...
          <h1 className="text-lg font-bold text-forest-800">コンペ管理</h1>
        </div>
      </div>
      ...
      <div className="max-w-lg mx-auto px-4 py-6 space-y-5">
        ...
        <div className="space-y-3">
          <Button
            ...
            size="lg"
            className="w-full"
            onClick={() => onManageReps(competitionId)}
          >
          ...
          <Button
            ...
            size="lg"
            className="w-full"
            onClick={() => onShowQR(competitionId)}
          >
